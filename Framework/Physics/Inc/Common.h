...
inline btVector3 TobtVector3(const ENgines::Math::Vector3& v)
{
	return btVector3(v.x, v.y, v.z);
}
inline ENgines::Math::Vector3 ToVector3(const btVector3& v)
{
	return {
...
inline ENgines::Math::Quaternion ToQuaternion(const btQuaternion& q)
{
	return {
...
inline btTransform ConvertTobtTransform(const ENgines::Graphics::Transform& transform)
{
