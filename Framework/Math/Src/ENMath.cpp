...
{
    const float w = sqrt(m._11 + m._22 + m._33 + 1.0f) * 0.5;
    const float x = sqrt(m._11 - m._22 - m._33 + 1.0f) * 0.5;
    const float y = sqrt(-m._11 + m._22 - m._33 + 1.0f) * 0.5;
    const float z = sqrt(-m._11 - m._22 + m._33 + 1.0f) * 0.5;
...
Quaternion Quaternion::Slerp(const Quaternion& q0, const Quaternion& q1, float t)
{
    ...
    const float scale1 = q1Scale * sinf(1.0f - t) / sinTheta;
