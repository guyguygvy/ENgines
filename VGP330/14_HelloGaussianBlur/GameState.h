...
protected:
	...
	ENgines::Graphics::GaussianBlurEffect mGaussianBlurEffect;
	ENgines::Graphics::PostProcessingEffect mPostProcessingEffect;
	ENgines::Graphics::RenderGroup mCharacter;
	ENgines::Graphics::RenderObject mGround;
	ENgines::Graphics::RenderObject mScreenQuad;
	ENgines::Graphics::RenderTarget mRenderTarget;
	ENgines::Graphics::RenderTarget mBloomRenderTarget;
};