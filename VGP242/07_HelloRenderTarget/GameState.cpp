...
void GameState::Initialize()
{
	...
	//Earth
	MeshPX mesh1 = MeshBuilder::CreateSpherePX(60, 60, 1.0f);
	mMeshBuffer.Initialize<MeshPX>(mesh1);
	mConstantBuffer.Initialize(sizeof(Matrix4));
	std::filesystem::path shaderFile1 = L"../../Assets/Shaders/DoTexture.fx";
	mVertexShader.Initialize<VertexPX>(shaderFile1);
	mPixelShader.Initialize(shaderFile1);
